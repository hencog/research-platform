...
<li class="<?php bp_activity_css_class(); ?> clearfix" id="activity-<?php bp_activity_id(); ?>">
	...
	<div class="activity-content">
		...
		<div class="activity-header">
			...
			<div class="activity-date"><?php echo bp_core_time_since( bp_get_activity_date_recorded() ); ?></div>
			<?php bp_activity_action( $args = array('no_timestamp' => true) ); ?>
		...
		<?php if ( is_user_logged_in() ) : ?>
			...
			<div class="activity-meta">
				...
				<?php if ( bp_activity_can_comment() ) : ?>
					...
					<a href="<?php bp_activity_comment_link(); ?>" class="button acomment-reply bp-primary-action" id="acomment-comment-<?php bp_activity_id(); ?>"><?php printf( __( '<span>%s</span> Comment', 'buddypress' ), bp_activity_get_comment_count() ); ?></a>
